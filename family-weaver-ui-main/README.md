...
```bash
git clone https://github.com/abdallahddumbakato/family-weaver-ui-main.git
cd family-story
```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/abdallahddumbakato/family-weaver-ui-main)
